...
copyright = 'Cédric Donner et Marlene Terra, Collège du Sud, 2024'
...
html_title = 'RS Playground'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'RS Playground'
